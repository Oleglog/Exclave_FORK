...
require (
	...
	github.com/openlibrecommunity/olcrtc v0.0.0-20260504164426-ca0df3e16abc
)
...
replace (
	github.com/openlibrecommunity/olcrtc => github.com/Oleglog/Olcrtc_manager v0.0.0-20260504164426-ca0df3e16abc
