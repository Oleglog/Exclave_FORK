...
require (
	...
	github.com/openlibrecommunity/olcrtc v0.0.0-20260530132006-67b0e2b74e1f
)
...
replace (
	...
	github.com/zarazaex69/j => github.com/Oleglog/j v0.0.0-20260530000013-1e4e663285ad
