...
require (
	...
	github.com/openlibrecommunity/olcrtc v0.0.0-20260504172529-f1fda1337e51
)
...
replace (
	github.com/openlibrecommunity/olcrtc => github.com/Oleglog/Olcrtc_manager v0.0.0-20260504172529-f1fda1337e51
